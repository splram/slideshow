...
var tith = ["పాడ్యమి", "విధియా", "తదియ", "చవితి", "పంచమి", "షష్టి", "సప్తమి", "అష్టమి", "నవమి", "దశమి", "ఏకాదశి", "ద్వాదశి", "త్రయోదశి", "చతుర్దశి", "అమావాస్య", "పాడ్యమి", "విధియా", "తదియ", "చవితి", "పంచమి", "షష్టి", "సప్తమి", "అష్టమి", "నవమి", "దశమి", "ఏకాదశి", "ద్వాదశి", "త్రయోదశి", "చతుర్దశి", "పౌర్ణమి"];
...
panchang = {
   ...
   calculate: function (d, cb) {
      ...
      this.samvatsara.name = samvatsara[yearMod-1] ;
      this.paksham.name = n_tithi < 15 ? "కృష్ణ":"శుక్ల";
